...
public class PurgeCache extends Module {
	...
	{
		 log.debug("This is custom logs of DE");
		...
		try
		{
		 ...
		 if (pageFile != null)
         {
             ...
             for ( Page page : pages )
             {
            	 ...
            	 String domainName = prop.getProperty(String.valueOf(data.getProcessorInstructions().getPublicationId().getItemId()).trim());
	             ...
	             log.debug("Custom code :- timeout value " + 5000);
